...
if debug:
    ...
    process.maxEvents.input = cms.untracked.int32(400000)
else:
    process.MessageLogger.cerr.FwkReport.reportEvery = 5000
...
process.load('DQM.GEMLocal.GEMDQM_cff')
...
process.dqmout = cms.EndPath(process.dqmEnv + process.dqmSaver + process.dqmSaverPB)
